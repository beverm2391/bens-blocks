...
# AI Mental Health Clinical Decision Support Tool
...
## Ben's Evaluation
**Rating:** cool idea/10  
**Worth making version 2?** Yes

**Pros:**
1. It works!
2. It's a cool proof of concept (decision support tools are the future)
3. It's open source
4. It might inspire you to build something cool

**Cons:**
1. It's not very well structured and needs to be refactored
2. It's not test driven
3. I have to pay OpenAI money every time I run it
4. Not yet validated on a large dataset

Alas, I think that it's valuable anyway! As they say:
>"If you're happy with it, it's not an MVP (Minimum Viable Product)."
...
Mount Google Drive to access drive files. Later we'll get the DSM-5 pdf.
``` python copy
...
Tutorial : [https://blocks.beneverman.com/blocks/text-extraction/pdf](https://blocks.beneverman.com/blocks/text-extraction/pdf)
